...
$inputs = [
    'form' => [ // id формы
        ...
        'phone' => 'isPhone', // очищает телефон от лишних символов и проверяет на количество цифер (7 - 25)
        ...
        'multiselect' => '',
        'message' => ['lenStr' => [5, 250, true]], // minLen, maxLen, ture - удалять все что превышает длину/false - возвращать как ошибку
        'checkbox-1' => '',
        'checkbox-2' => '',
        'radio-btn' => '',
    ]
